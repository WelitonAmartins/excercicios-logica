 ...
 * correspondência a cada umdeles anunciando um bônus especial.
 * Escreva um algoritmo que leia o nome do cliente e o valor
 *  das suas compras no ano passado e calcule um bônus de 10% se 
 *  o valor das compras for menor que 5.000 e de 15%, caso contrário
 */
	...
	public static void main(String[] args) {
		...
		for (int j = 0; j < 1; j++) {
			JOptionPane.showMessageDialog(null,
					String.format("O cliente %s irá receber %.2f de bônus! \nO cliente %s irá receber %.2f de bônus! \nO cliente %s irá receber %.2f de bônus!",
